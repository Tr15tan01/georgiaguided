...
export default async function LoginPage() {
  ...
  return (
    <main className="grid min-h-dvh lg:grid-cols-[1fr_minmax(0,32rem)]">
      <div className="relative hidden overflow-hidden bg-[#10150f] lg:block" aria-hidden>
        <svg viewBox="0 0 800 900" preserveAspectRatio="xMidYMid slice" className="absolute inset-0 size-full">
          <defs>
            <linearGradient id="sky" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#1d2b20" /><stop offset="1" stopColor="#245c3d" /></linearGradient>
          </defs>
          <rect width="800" height="900" fill="url(#sky)" />
          <path d="M0 620 L140 430 L220 520 L360 300 L470 470 L560 380 L800 640 L800 900 L0 900Z" fill="#10150f" opacity=".75" />
          <path d="M340 330 L360 300 L382 334 L368 326 L356 340Z" fill="#e6ecdf" opacity=".8" />
          <path d="M0 720 L180 600 L330 690 L520 560 L800 740 L800 900 L0 900Z" fill="#080d08" />
        </svg>
        <div className="absolute bottom-12 left-12 max-w-sm text-[#e6ecdf]">
